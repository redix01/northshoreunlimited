...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    // POST as well as DELETE: shared hosts and WAFs quite often reject the
    // less common verbs outright, and the panel is the only caller.
    Route::match(['delete', 'post'], '/users/{user}', [Admin\UserController::class, 'destroy'])->name('admin.users.destroy');
