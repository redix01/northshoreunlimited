...
const legalLinks = [
    ...
    { label: 'Privacy Policy', description: 'How we handle your data', href: '/compliance#data-protection' },
    { label: 'Compliance', description: 'Licensing & certifications', href: '/compliance' },
    { label: 'Proof of Reserves', description: 'Asset verification', href: '/#proof-of-reserves' },
];
...
const sections: { id: string; number: string; title: string; blocks: Block[] }[] = [
    {
        id: 'agreement',
        number: '01',
        ...
        blocks: [
            ...
            {
                kind: 'p',
                text: 'By accessing or using our Services, you acknowledge that you have read, understood, and agree to be bound by these Terms. If you do not agree to these Terms, you must not access or use our Services.',
            },
            {
                kind: 'p',
                text: 'We reserve the right to modify these Terms at any time. We will notify you of material changes by posting the updated Terms on our platform and updating the "Last Updated" date. Your continued use of the Services after such changes constitutes acceptance of the modified Terms.',
            },
        ],
    },
    {
        ...
        title: 'Eligibility',
        blocks: [
            { kind: 'p', text: 'To use our Services, you must:' },
            {
                kind: 'sub',
                title: 'Age Requirement',
                text: 'Be at least 18 years of age or the age of majority in your jurisdiction, whichever is greater. By using our Services, you represent and warrant that you meet this age requirement.',
            },
            {
                kind: 'sub',
                title: 'Jurisdictional Restrictions',
                text: 'You must be a resident of a jurisdiction where our Services are available. Our Services are currently available to residents of the United States, excluding New York (pending BitLicense approval) and Hawaii. We do not offer Services to persons located in, or residents of, any jurisdiction subject to comprehensive U.S. sanctions.',
            },
            {
                kind: 'sub',
                title: 'Legal Capacity',
                text: 'You must have the legal capacity to enter into a binding agreement. If you are using our Services on behalf of an entity, you represent that you have authority to bind that entity to these Terms.',
            },
        ],
    },
    {
        ...
        blocks: [
            {
                kind: 'p',
                text: 'To access certain features, you must create an account. When registering, you agree to provide accurate, current, and complete information and to update such information as necessary.',
            },
            {
                kind: 'p',
                text: 'You are solely responsible for maintaining the confidentiality of your account credentials and for all activity that occurs under your account. You agree to immediately notify us of any unauthorized use of your account or any other breach of security.',
            },
            {
                kind: 'p',
                text: 'We reserve the right to suspend or terminate your account at any time if we reasonably believe that you have violated these Terms or applicable law, or if required by law enforcement or regulatory authorities.',
            },
        ],
    },
    {
        ...
        blocks: [
            ...
            },
            {
                ...
                text: 'Interactive courses, tutorials, quizzes, and learning paths covering blockchain technology, decentralized finance (DeFi), NFTs, smart contracts, and related topics. All educational content is for informational purposes only and does not constitute financial, investment, legal, or tax advice.',
            },
            {
                kind: 'sub',
            ...
            },
            {
                ...
                text: 'Our platform integrates with a points and rewards system to incentivize learning. See Section 5 for full details on the Points & Rewards Program.',
            },
        ],
    },
    {
        ...
        blocks: [
            ...
            },
            {
                kind: 'sub',
                title: 'Anti-Abuse',
                text: 'Any attempt to manipulate, game, or abuse the Program — including but not limited to creating multiple accounts, using automated scripts, or exploiting bugs — will result in forfeiture of all points and may lead to account termination.',
            },
            {
                kind: 'notice',
    ...
    },
    {
        id: 'promotions',
        number: '06',
        title: 'Marketing, Promotions & Offer Eligibility',
        blocks: [
            {
                kind: 'p',
            ...
            {
                kind: 'sub',
                title: 'Offer-Specific Terms',
                text: 'Each Promotional Offer may be subject to additional terms, conditions, and eligibility requirements, which will be disclosed at the time the offer is presented to you in your dashboard or via direct communication. In the event of a conflict between these Terms and any offer-specific terms, the offer-specific terms shall control with respect to that Promotional Offer.',
            },
            {
                kind: 'notice',
                title: 'Important Notice',
    ...
    },
    {
        id: 'user-assets',
        number: '07',
        title: 'User Assets & Custodial Services',
        blocks: [
            { kind: 'p', text: 'If you use our custodial services to store digital assets:' },
            {
                kind: 'sub',
    ...
    },
    {
        ...
        blocks: [
            ...
            {
                kind: 'p',
                text: 'We grant you a limited, non-exclusive, non-transferable, revocable license to access and use the Services for your personal, non-commercial educational purposes, subject to these Terms.',
            },
            {
                kind: 'p',
                text: 'You may not reproduce, distribute, modify, create derivative works of, publicly display, publicly perform, republish, download, store, or transmit any material from our Services without our prior written consent, except as incidental to normal web browsing or as expressly permitted by these Terms.',
            },
        ],
    },
    {
        ...
        blocks: [
            { kind: 'p', text: 'You agree not to engage in any of the following prohibited activities:' },
            {
                kind: 'list',
                items: [
                    'Using the Services for money laundering, terrorist financing, or any other financial crime',
                    'Violating any applicable sanctions, including those administered by OFAC',
                    'Creating multiple accounts to abuse the rewards system or circumvent restrictions',
                    'Using automated means (bots, scrapers, scripts) to access or interact with the Services without authorization',
                    'Attempting to gain unauthorized access to any part of the Services, other accounts, or computer systems',
                    ...
                    'Using the Services to transmit harmful code, including viruses, trojans, or malware',
    ...
    },
    {
        ...
        blocks: [
            {
                kind: 'p',
                text: 'THE SERVICES ARE PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.',
            },
            {
                kind: 'p',
                text: 'NORTHSHORE UNLIMITED DOES NOT PROVIDE INVESTMENT, FINANCIAL, TAX, OR LEGAL ADVICE. ALL EDUCATIONAL CONTENT IS FOR INFORMATIONAL PURPOSES ONLY. YOU SHOULD CONSULT QUALIFIED PROFESSIONALS BEFORE MAKING ANY FINANCIAL DECISIONS.',
            },
            {
                kind: 'p',
                text: 'TO THE MAXIMUM EXTENT PERMITTED BY LAW, NORTHSHORE UNLIMITED SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, RESULTING FROM: (A) YOUR ACCESS TO OR USE OF OR INABILITY TO ACCESS OR USE THE SERVICES; (B) ANY CONDUCT OR CONTENT OF ANY THIRD PARTY ON THE SERVICES; (C) UNAUTHORIZED ACCESS, USE, OR ALTERATION OF YOUR TRANSMISSIONS OR CONTENT; OR (D) DIGITAL ASSET PRICE FLUCTUATIONS.',
            },
            {
                kind: 'p',
                text: 'IN NO EVENT SHALL NORTHSHORE UNLIMITED’S AGGREGATE LIABILITY EXCEED THE GREATER OF (A) THE AMOUNT YOU PAID TO NORTHSHORE UNLIMITED IN THE 12 MONTHS PRECEDING THE CLAIM, OR (B) $10,000.',
            },
            {
                kind: 'notice',
    ...
    },
    {
        ...
        blocks: [
            ...
            },
            {
                kind: 'sub',
                title: 'Severability',
                text: 'If any provision of these Terms is held to be unenforceable, such provision shall be modified to the minimum extent necessary to make it enforceable, and the remaining provisions shall continue in full force and effect.',
            },
            {
                kind: 'sub',
                title: 'Waiver',
...
function BlockContent({ block }: { block: Block }): ReactNode {
    if (block.kind === 'p') {
        return <p className="text-base leading-relaxed text-white/50">{block.text}</p>;
    }

    if (block.kind === 'sub') {
        return (
            <div>
                <h4 className="mb-3 text-base font-medium text-white">{block.title}</h4>
                <p className="text-base leading-relaxed text-white/50">{block.text}</p>
            </div>
        );
    }
        ...
        return (
            <ul className="space-y-3">
                {block.items.map((item) => (
                    <li key={item} className="flex gap-4 text-base leading-relaxed text-white/50">
    ...
    return (
        <div className="rounded-xl border border-gold/20 bg-gold/5 p-8">
            <div className="mb-3 flex items-center gap-3">
                ...
                <h4 className="text-[11px] font-semibold uppercase tracking-[0.2em] text-gold">{block.title}</h4>
            </div>
            ...
            <main className="pt-20 xl:pt-24">
                ...
                <section className="mx-auto max-w-7xl px-6 pt-20 md:px-12 md:pt-28">
                    <motion.div initial="initial" animate="animate" variants={staggerContainer} className="max-w-4xl">
                        ...
                        <motion.p variants={fadeIn} className="mb-8 text-lg leading-relaxed text-white/60">
                        ...
                        <motion.div
                            variants={fadeIn}
                            className="flex flex-wrap gap-x-8 gap-y-2 text-[11px] uppercase tracking-[0.2em] text-white/30"
                        >
                ...
                {/* Legal index + on this page */}
                <section className="mx-auto max-w-7xl px-6 py-20 md:px-12">
                    <p className="mb-8 text-[10px] font-semibold uppercase tracking-[0.3em] text-white/25">
                        Legal &amp; Compliance
                    </p>
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        {legalLinks.map((item) => (
                            <Link
                                key={item.label}
                                href={item.href}
                                className="rounded-xl border border-elegant-border bg-elegant-card p-7 transition-colors hover:border-gold/25"
                            >
                                <span className="mb-2 block text-sm font-medium text-white">{item.label}</span>
                                <span className="block text-xs text-white/40">{item.description}</span>
                            </Link>
                        ))}
                    </div>

                    <div className="mt-16 border-t border-elegant-border pt-10">
                        <p className="mb-8 text-[10px] font-semibold uppercase tracking-[0.3em] text-white/25">
                            On This Page
                        </p>
                        <div className="grid gap-x-10 gap-y-4 sm:grid-cols-2 lg:grid-cols-3">
                            {sections.map((section) => (
                                <a
                                    key={section.id}
                                    href={`#${section.id}`}
                                    className="group flex items-baseline gap-4 text-sm text-white/50 transition hover:text-gold"
                                >
                                    <span className="font-serif text-xs italic text-white/25 transition group-hover:text-gold">
                                        {section.number}
                                    </span>
                                    {section.title}
                                </a>
                ...
                <div className="mx-auto max-w-7xl px-6 md:px-12">
                    {sections.map((section) => (
                        <section
                            key={section.id}
                            id={section.id}
                            className="grid gap-10 border-t border-elegant-border py-20 lg:grid-cols-[220px_1fr]"
                        >
                            <div>
                                <span className="mb-3 block font-serif text-2xl italic text-gold">
                                    {section.number}
                                </span>
                                <h3 className="font-serif text-2xl italic leading-snug text-white">{section.title}</h3>
                            </div>
                            <div className="max-w-3xl space-y-8">
                                {section.blocks.map((block, index) => (
                                    <BlockContent key={`${section.id}-${index}`} block={block} />
                                ))}
                            </div>
                        </section>
                    ))}
                ...
                {/* Contact */}
                <section className="mx-auto max-w-7xl border-t border-elegant-border px-6 py-24 md:px-12">
                    <div className="max-w-3xl">
                        <h3 className="mb-6 font-serif text-3xl italic text-white">Questions about these Terms?</h3>
                        ...
                        <div className="flex flex-wrap gap-5">
                            <Link
                                href="/compliance"
                                className="rounded-sm border border-elegant-border px-8 py-4 text-xs font-bold uppercase tracking-widest text-white transition hover:bg-white/5"
                            >
                                View Compliance
                            </Link>
                            <a
                                href="/#contact"
                                className="rounded-sm bg-white px-8 py-4 text-xs font-bold uppercase tracking-widest text-black transition hover:bg-neutral-200"
                            >
                                Talk to an Advisor
                            </a>
                        </div>
