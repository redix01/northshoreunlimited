...
const whyUs = [
    {
        ...
        icon: <Headphones className="h-5 w-5 text-gold-ink/60" />,
    },
    {
...
const wealthPillars = [
    {
        ...
        icon: <Timer className="h-5 w-5 text-gold-ink/60" />,
    },
    {
        ...
        icon: <Target className="h-5 w-5 text-gold-ink/60" />,
    },
    {
        ...
        icon: <Gauge className="h-5 w-5 text-gold-ink/60" />,
    },
];
...
function ToggleGroup<T extends string | number>({
    ...
    return (
        <div>
            <span className="mb-3 block text-[10px] font-semibold uppercase tracking-[0.3em] text-ink/60">
                {label}
            </span>
                    ...
                    <button
                        ...
                        className={`rounded-sm border px-4 py-2 text-xs font-medium transition ${
                            option.value === value
                                ...
                                : 'border-elegant-border text-ink/65 hover:border-ink/20 hover:text-ink/85'
                        }`}
                    >
                        {option.label}
                    </button>
        ...
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-px overflow-hidden rounded-xl border border-elegant-border bg-elegant-border">
                    <div className="bg-elegant-card p-6">
                        <span className="mb-2 block text-[10px] uppercase tracking-[0.2em] text-ink/60">
                            Total Invested
                        </span>
                        <p className="font-serif text-2xl italic text-ink">{currency(model.invested)}</p>
                    </div>
                    <div className="bg-elegant-card p-6">
                        <span className="mb-2 block text-[10px] uppercase tracking-[0.2em] text-ink/60">
                            Portfolio Value
                        </span>
                        <p className="font-serif text-2xl italic text-ink">{currency(model.value)}</p>
                    </div>
                    <div className="bg-elegant-card p-6">
                        <span className="mb-2 block text-[10px] uppercase tracking-[0.2em] text-ink/60">
                            Return
                        </span>
                        <p className="font-serif text-2xl italic text-gold-ink">+{model.returnPct.toFixed(1)}%</p>
                    </div>
                    <div className="bg-elegant-card p-6">
                        <span className="mb-2 block text-[10px] uppercase tracking-[0.2em] text-ink/60">
                            BTC Accumulated
                        </span>
                        <p className="font-serif text-2xl italic text-ink">{model.btc.toFixed(4)}</p>
                    </div>
                </div>
            ...
            <div className="rounded-xl border border-elegant-border bg-elegant-card p-6 md:p-10">
                <div className="flex gap-6">
                    <div className="flex flex-col justify-between py-1 text-right text-[10px] uppercase tracking-widest text-ink/55">
                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-4 flex justify-between text-[10px] uppercase tracking-widest text-ink/55">
                ...
                <div className="mt-8 flex flex-wrap items-center gap-8 border-t border-elegant-border pt-6 text-[11px] uppercase tracking-[0.2em] text-ink/62">
                    <span className="flex items-center gap-3">
                        <span className="h-0.5 w-6 bg-gold" />
                        Portfolio Value
                    </span>
                    <span className="flex items-center gap-3">
                        <span className="h-0.5 w-6 border-t border-dashed border-ink/30" />
                        Amount Invested
                    </span>
                </div>

                <p className="mt-6 text-[10px] uppercase tracking-[0.2em] text-ink/55">
...
function TestimonialCard({
    ...
    return (
        <figure className="flex w-[340px] shrink-0 flex-col justify-between rounded-xl border border-elegant-border bg-elegant-card p-8 md:w-[400px]">
            <blockquote className="text-sm leading-relaxed text-ink/70">&ldquo;{quote}&rdquo;</blockquote>
            <figcaption className="mt-8 flex items-center gap-4">
                <span className="flex h-10 w-10 items-center justify-center rounded-full border border-elegant-border bg-gold/10 text-[11px] font-semibold tracking-wider text-gold-ink">
                    {initials}
                </span>
                <span>
                    <span className="block text-sm font-medium text-ink">{name}</span>
                    <span className="block text-[10px] uppercase tracking-[0.2em] text-ink/60">{role}</span>
                </span>
            </figcaption>
        </figure>
    );
...
export default function HomePage() {
    ...
    const inputClass =
        'w-full border-b border-elegant-border bg-transparent py-4 text-sm text-ink placeholder:text-ink/55 outline-none transition focus:border-gold';
            ...
            <main className="pt-20 xl:pt-24">
                ...
                <section id="hero" className="mx-auto max-w-7xl px-6 pt-16 md:px-12 md:pt-24">
                    <div className="grid gap-16 lg:grid-cols-[1.2fr_1fr] lg:items-center">
                        <motion.div initial="initial" animate="animate" variants={staggerContainer}>
                            ...
                            <motion.h2
                                variants={fadeIn}
                                className="font-serif text-5xl font-normal leading-[1.1] italic text-ink md:text-6xl"
                            >
                            ...
                            <motion.div variants={fadeIn} className="mt-12 flex flex-wrap gap-5">
                                <a
                                    href="#contact"
                                    className="rounded-sm bg-gold px-8 py-4 text-xs font-bold uppercase tracking-widest text-ink transition-all hover:bg-gold-dark"
                                >
                                    Start Investing
                                </a>
                                <a
                                    href="#contact"
                                    className="rounded-sm border border-elegant-border bg-transparent px-8 py-4 text-xs font-bold uppercase tracking-widest text-ink transition hover:bg-ink/5"
                                >
                                    Talk to an Advisor
                                </a>
                            </motion.div>
                    ...
                    <div className="mx-auto grid max-w-7xl grid-cols-2 gap-px bg-elegant-border md:grid-cols-4">
                        {heroStats.map((stat) => (
                            <div key={stat.label} className="bg-elegant-bg px-6 py-14 text-center">
                                <p className="mb-3 font-serif text-4xl italic text-ink">{stat.value}</p>
                                <p className="text-[10px] font-semibold uppercase tracking-[0.3em] text-ink/60">
                                    {stat.label}
                                </p>
                            </div>
                        ))}
                ...
                <section id="why-us" className="mx-auto max-w-7xl px-6 py-24 md:px-12">
                    <div className="mb-16 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                        ...
                        <a
                            href="#contact"
                            className="w-fit rounded-sm border border-elegant-border px-8 py-4 text-xs font-bold uppercase tracking-widest text-ink transition hover:bg-ink/5"
                        >
                            Create your account
                        </a>
                    </div>
                    ...
                    <div className="grid gap-16 md:grid-cols-3">
                        {whyUs.map((item) => (
                            <div key={item.title} className="group">
                                ...
                                <h4 className="mb-4 text-lg font-medium text-ink">{item.title}</h4>
                ...
                <section id="comparison" className="mx-auto max-w-7xl border-t border-elegant-border px-6 py-24 md:px-12">
                    <div className="mb-14 max-w-3xl">
                        <h3 className="mb-4 font-serif text-4xl italic text-ink">Trade BTC With Expert Guidance</h3>
                        <p className="text-lg text-ink/62">Every step of the way</p>
                    </div>
                        ...
                        <table className="w-full min-w-[640px] border-collapse text-left">
                            <thead>
                                <tr className="border-b border-elegant-border bg-elegant-card">
                                    <th className="px-8 py-6 text-[10px] font-semibold uppercase tracking-[0.3em] text-ink/60">
                                        Feature
                                    </th>
                                    <th className="px-8 py-6 text-[10px] font-semibold uppercase tracking-[0.3em] text-ink/60">
                                        Other Brokers
                            ...
                            <tbody>
                                {comparison.map((row) => (
                                    <tr key={row.feature} className="border-b border-elegant-border last:border-b-0">
                                        <td className="px-8 py-6 text-sm font-medium text-ink">{row.feature}</td>
                                        <td className="px-8 py-6 text-sm text-ink/62">
                                            <span className="flex items-center gap-3">
                                                <XIcon className="h-4 w-4 shrink-0 text-ink/55" />
                                                {row.others}
                                            </span>
                                        </td>
                                        <td className="bg-gold/[0.05] px-8 py-6 text-sm text-ink/85">
                                            <span className="flex items-center gap-3">
                                                <Check className="h-4 w-4 shrink-0 text-gold-ink" />
                                                {row.ours}
                                            </span>
                                        </td>
                                    </tr>
                    ...
                    <div className="mt-12">
                        <a
                            href="#contact"
                            className="inline-block rounded-sm bg-gold px-10 py-4 text-xs font-bold uppercase tracking-widest text-ink transition hover:bg-gold-dark"
                        >
                ...
                {/* Free tools */}
                <section id="tools" className="border-y border-elegant-border bg-gold/[0.04]">
                    <div className="mx-auto max-w-7xl px-6 py-24 md:px-12">
                        <p className="mb-4 text-[11px] font-semibold uppercase tracking-[0.3em] text-gold-ink">
                            Free Tools
                        </p>
                        <h3 className="mb-4 font-serif text-4xl italic text-ink">Assess Your Portfolio</h3>
                        <p className="mb-16 text-lg text-ink/62">Use our free tools to understand where you stand</p>
                        ...
                        <div className="grid gap-8 md:grid-cols-3">
                            {tools.map((tool, index) => (
                                ...
                                >
                                    ...
                                    <h4 className="mb-4 text-lg font-medium text-ink">{tool.title}</h4>
                                    <p className="text-sm leading-relaxed text-ink/65">{tool.description}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <section id="calculator" className="mx-auto max-w-7xl px-6 py-24 md:px-12">
                    <div className="mb-16 max-w-3xl">
                        <h3 className="mb-4 font-serif text-4xl italic text-ink">Build Your Bitcoin Stack</h3>
                ...
                <section id="wealth" className="mx-auto max-w-7xl border-t border-elegant-border px-6 py-24 md:px-12">
                    <div className="mb-16 max-w-3xl">
                        <h3 className="mb-6 font-serif text-4xl italic text-ink">
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        {wealthPillars.map((pillar) => (
                            ...
                            >
                                ...
                                <h4 className="mb-4 text-lg font-medium text-ink">{pillar.title}</h4>
                ...
                <section
                    ...
                    className="border-y border-elegant-border bg-gold/[0.04]"
                >
                    <div className="mx-auto max-w-7xl px-6 py-24 md:px-12">
                        <p className="mb-4 text-[11px] font-semibold uppercase tracking-[0.3em] text-gold-ink">
                            Proof of Reserves
                        </p>
                        <h3 className="mb-8 max-w-3xl font-serif text-4xl italic leading-[1.15] text-ink">
                        ...
                        <div className="grid grid-cols-2 gap-px overflow-hidden rounded-xl border border-elegant-border bg-elegant-border md:grid-cols-4">
                            {reserveStats.map((stat) => (
                                <div key={stat.label} className="bg-elegant-card px-8 py-12 text-center">
                                    <p className="mb-3 font-serif text-3xl italic text-ink">{stat.value}</p>
                                    <p className="text-[10px] font-semibold uppercase tracking-[0.3em] text-ink/60">
                                        {stat.label}
                                    </p>
                                </div>
                ...
                <section id="testimonials" className="py-24">
                    ...
                    <div className="mx-auto mt-16 max-w-7xl px-6 md:px-12">
                            ...
                            {socialPosts.map((post) => (
                                ...
                                >
                                    <div className="mb-5 flex items-center justify-between">
                                        <div>
                                            <p className="text-sm font-medium text-ink">{post.name}</p>
                                            <p className="text-[11px] tracking-wider text-ink/60">{post.handle}</p>
                                        </div>
                                        <span className="text-[10px] uppercase tracking-[0.2em] text-ink/55">
                                            {post.date}
                                        </span>
                                    </div>
                                    <p className="text-sm leading-relaxed text-ink/70">{post.body}</p>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="mt-16 border-t border-elegant-border pt-12">
                            ...
                            <p className="mt-8 text-center text-[10px] font-semibold uppercase tracking-[0.3em] text-ink/55">
                ...
                <section id="portal" className="border-t border-elegant-border">
                    <div className="mx-auto max-w-7xl px-6 py-24 md:px-12">
                        <div className="grid gap-16 lg:grid-cols-[1fr_1.1fr] lg:items-center">
                            <div>
                                <h3 className="mb-6 font-serif text-4xl italic text-ink">Your Client Portal</h3>
                                <p className="mb-10 max-w-md text-lg leading-relaxed text-ink/62">
                            ...
                            <div className="min-w-0 rounded-xl border border-elegant-border bg-elegant-card p-4 md:p-6">
                                <ul className="divide-y divide-elegant-border">
                                    {portalActivity.map((item, index) => (
                                        ...
                                        >
                                            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-elegant-border bg-gold/10 text-[11px] font-semibold text-gold-ink">
                                                {item.initial}
                                            </span>
                                            <span className="min-w-0 flex-1 truncate text-sm text-ink/78">
                                                {item.text}
                                            </span>
                                            <span className="shrink-0 text-[10px] uppercase tracking-[0.2em] text-ink/55">
                                                {item.time}
                                            </span>
                                        </li>
                                    ))}
                ...
                <section id="contact" className="border-t border-elegant-border">
                    <div className="mx-auto max-w-7xl px-6 py-24 md:px-12">
                        <div className="grid gap-16 lg:grid-cols-[1.5fr_1fr]">
                            <div>
                                <h3 className="mb-6 font-serif text-4xl italic text-ink">Talk to an Advisor</h3>
                                ...
                                {!submitted ? (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start gap-4 py-4">
                                            ...
                                            <label
                                                htmlFor="consent"
                                                className="cursor-pointer select-none text-[10px] uppercase tracking-wider text-ink/60"
                                            >
                                    ...
                                    >
                                        ...
                                        <h4 className="mb-2 text-xl text-ink">Request Received</h4>
                            ...
                            <div className="space-y-8">
                                <div className="rounded-xl border border-elegant-border bg-elegant-card p-10">
                                    ...
                                    <div className="space-y-6">
                                        <div className="flex items-center justify-between gap-4 text-xs">
                                            <span className="text-ink/62">EMAIL</span>
                                            <span className="font-medium text-ink/85">trades@northshore.com</span>
                                        </div>
                                        <div className="flex items-center justify-between gap-4 text-xs">
                                            <span className="text-ink/62">HOURS</span>
                                            <span className="text-right font-medium text-ink/85">
                                                Mon &ndash; Fri, 9:00 AM &ndash; 5:00 PM
                                            </span>
                                        </div>
                                        <div className="flex items-center justify-between gap-4 text-xs">
                                            <span className="text-ink/62">SERVICE STATUS</span>
                                            <span className="font-medium tracking-widest text-gold-ink">&bull; ONLINE</span>
                                        </div>
                                        <div className="flex items-center justify-between gap-4 text-xs">
                                            <span className="text-ink/62">SLA WINDOW</span>
                                            <span className="font-medium text-ink/85">SAME-DAY SETTLEMENT</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div
                                    id="affiliates"
                                    className="rounded-xl border border-elegant-border bg-gold/[0.04] p-10"
                                >
                                    <h4 className="mb-4 text-[10px] font-semibold uppercase tracking-[0.3em] text-gold-ink">
                                        Become an Affiliate
                                    </h4>
                                    <p className="text-sm leading-relaxed text-ink/65">
                ...
                <section id="cta" className="border-t border-elegant-border">
                    <div className="mx-auto max-w-7xl px-6 py-28 text-center md:px-12">
                        ...
                        <div className="flex flex-wrap justify-center gap-5">
                            <a
                                href="#contact"
                                className="rounded-sm bg-gold px-10 py-4 text-xs font-bold uppercase tracking-widest text-ink transition hover:bg-gold-dark"
                            >
                                Start Investing Today
                            </a>
                            <a
                                href="#contact"
                                className="rounded-sm border border-elegant-border px-10 py-4 text-xs font-bold uppercase tracking-widest text-ink transition hover:bg-ink/5"
                            >
                                Talk to an Advisor
                            </a>
                        </div>
                        <p className="mt-10 text-[11px] uppercase tracking-[0.2em] text-ink/55">
