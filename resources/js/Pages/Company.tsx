    ...
    return (
        <SiteChrome>
            <main className="pt-20 xl:pt-24">
                ...
                <section className="mx-auto mt-24 max-w-7xl border-t border-elegant-border px-6 py-24 md:px-12">
                    <div className="grid gap-16 lg:grid-cols-2">
                        <div>
                            ...
                            <h3 className="mb-8 font-serif text-3xl italic leading-snug text-white">
                        ...
                        <div>
                            ...
                            <blockquote className="border-l border-gold/40 pl-8 font-serif text-xl italic leading-relaxed text-white/80">
                ...
                {/* Values */}
                <section className="border-y border-elegant-border bg-white/[0.01]">
                    <div className="mx-auto max-w-7xl px-6 py-24 md:px-12">
                        <p className="mb-4 text-[11px] font-semibold uppercase tracking-[0.3em] text-gold">
                            The Northshore Team
                        </p>
                        <h3 className="mb-4 font-serif text-4xl italic text-white">What We Stand For</h3>
                        <p className="mb-16 text-lg text-white/40">Values that guide every conversation</p>
                        ...
                        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                            {values.map((value, index) => (
                                ...
                                >
                                    ...
                                    <h4 className="mb-4 text-lg font-medium text-white">{value.title}</h4>
                ...
                <section className="mx-auto max-w-7xl px-6 py-24 md:px-12">
                    ...
                    <h3 className="mb-16 font-serif text-4xl italic text-white">Trusted by Real People</h3>
                    ...
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                        {clientStories.map((story) => (
                            ...
                            >
                                <blockquote className="text-sm leading-relaxed text-white/60">
                                    &ldquo;{story.quote}&rdquo;
                                </blockquote>
                                <figcaption className="mt-8">
                                    <span className="block text-sm font-medium text-white">{story.name}</span>
                ...
                <section className="border-t border-elegant-border">
                    <div className="mx-auto max-w-7xl px-6 py-24 md:px-12">
                        <div className="grid gap-16 lg:grid-cols-[1fr_1fr] lg:items-center">
                            <div>
                                <h3 className="mb-8 font-serif text-4xl italic text-white">
                                ...
                                <dl className="divide-y divide-elegant-border border-y border-elegant-border">
                                    {contactRows.map((detail) => (
                                        ...
                                        >
                                            ...
                                            <dd className="text-right text-white/80">{detail.value}</dd>
                                        </div>
                                    ))}
                                </dl>
                            </div>
                            ...
                            <div className="rounded-2xl border border-elegant-border bg-elegant-card p-12">
                                <h3 className="mb-6 font-serif text-3xl italic text-white">Ready to Talk?</h3>
                                <p className="mb-10 text-base leading-relaxed text-white/50">
